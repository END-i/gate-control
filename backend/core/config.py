...
class Settings(BaseSettings):
    ...
    webhook_auth_mode: Literal["token", "hmac", "basic"] = Field(default="token", alias="WEBHOOK_AUTH_MODE")
    webhook_hmac_secret: str = Field(default="", alias="WEBHOOK_HMAC_SECRET")
    webhook_basic_username: str = Field(default="", alias="WEBHOOK_BASIC_USERNAME")
    webhook_basic_password: str = Field(default="", alias="WEBHOOK_BASIC_PASSWORD")
